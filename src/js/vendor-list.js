...
function displayVendors(arr) {
  ...
  const icons = {
    ...
    "photographer": '<svg class="card-icon" viewBox="0 0 20 18" preserveAspectRatio="xMinYMid meet"><path fill="#FFFFFF" d="m2,2l3,0l2,-2l6,0l2,2l3,0a2,2 0 0 1 2,2l0,12a2,2 0 0 1 -2,2l-16,0a2,2 0 0 1 -2,-2l0,-12a2,2 0 0 1 2,-2m8,3a5,5 0 0 0 -5,5a5,5 0 0 0 5,5a5,5 0 0 0 5,-5a5,5 0 0 0 -5,-5m0,2a3,3 0 0 1 3,3a3,3 0 0 1 -3,3a3,3 0 0 1 -3,-3a3,3 0 0 1 3,-3z" /></svg>',
    "videographer": '<svg class="card-icon" viewBox="0 0 18 12" preserveAspectRatio="xMinYMid meet"><path fill="#FFFFFF" d="m14,4.5l0,-3.5a1,1 0 0 0 -1,-1l-12,0a1,1 0 0 0 -1,1l0,10a1,1 0 0 0 1,1l12,0a1,1 0 0 0 1,-1l0,-3.5l4,4l0,-11l-4,4z" /></svg>',
    "caterer": '<svg class="card-icon" viewBox="0 0 22 22"><path fill="#FFFFFF" d="m20,20l0,-4c0,-1.11 -0.9,-2 -2,-2l-1,0l0,-3c0,-1.11 -0.9,-2 -2,-2l-3,0l0,-2l-2,0l0,2l-3,0c-1.11,0 -2,0.89 -2,2l0,3l-1,0c-1.11,0 -2,0.89 -2,2l0,4l-2,0l0,2l22,0l0,-2m-11,-14a2,2 0 0 0 2,-2c0,-0.38 -0.1,-0.73 -0.29,-1.03l-1.71,-2.97l-1.72,2.97c-0.18,0.3 -0.28,0.65 -0.28,1.03a2,2 0 0 0 2,2z" /></svg>',
